...
class ActiveRecord::ConnectionAdapters::PostgreSQLAdapter < ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def execute(sql, name = nil); end
  def execute_and_clear(sql, *args, &block); end
  def execute_and_clear_without_marginalia(sql, name, binds, prepare: nil); end
  def execute_without_marginalia(sql, name = nil); end
