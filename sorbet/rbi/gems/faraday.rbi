...
class Anonymous_Faraday_Options_81 < Faraday::Options
  def bind; end
  def bind=(_); end
  def boundary; end
  def boundary=(_); end
...
class Faraday::RequestOptions < Anonymous_Faraday_Options_81
  def []=(key, value); end
  def stream_response?; end
end
class Anonymous_Faraday_Options_82 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_82
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_83 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_83
...
class Anonymous_Faraday_Options_84 < Faraday::Options
  def builder; end
  def builder=(_); end
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_84
  def builder_class; end
  def new_builder(block); end
  def request; end
  def ssl; end
end
class Anonymous_Faraday_Options_85 < Faraday::Options
  def method; end
  def method=(_); end
  def parallel_manager; end
  def parallel_manager=(_); end
...
class Faraday::Env < Anonymous_Faraday_Options_85
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_86
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
...
class Faraday::Request::Retry::Options < Anonymous_Faraday_Options_87
  def backoff_factor; end
  def exceptions; end
  def interval; end
  def interval_randomness; end
