...
#              user_slack_omniauth_authorize GET|POST   /users/auth/slack(.:format)                                                              devise/omniauth_callbacks#passthru
#               user_slack_omniauth_callback GET|POST   /users/auth/slack/callback(.:format)                                                     devise/omniauth_callbacks#slack
# user_sign_in_with_slack_omniauth_authorize GET|POST   /users/auth/sign_in_with_slack(.:format)                                                 devise/omniauth_callbacks#passthru
#  user_sign_in_with_slack_omniauth_callback GET|POST   /users/auth/sign_in_with_slack/callback(.:format)                                        devise/omniauth_callbacks#sign_in_with_slack
